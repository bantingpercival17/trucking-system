        ...
        <div class="modal fade" id="newTripModal" tabindex="-1" aria-labelledby="newTripModalLabel"
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content border-0 shadow">
                    <form method="POST" action="{{ route('watson.trips.store') }}">
                        @csrf

                        <div class="modal-header bg-light">
                            <div>
                                <h5 class="modal-title fw-semibold text-primary" id="newTripModalLabel">Create New Trip
                                </h5>
                                ...
                                <div class="row g-2 g-lg-3">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <select name="destination_id" id="destinationSelect"
                                            class="form-select select2-destination border border-primary" required>
                            ...
                            <div class="mb-2">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="truck_id" id="truckSelect"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="driver_id" class="form-select border border-primary" required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="row g-2 g-lg-3">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <select name="destination_id" class="form-select border border-primary"
                                                    required>
            ...
            <div class="card-header bg-transparent border-0 pb-0">
                ...
                <div
                    ...
                    <div class="ui-trips-head-left">
                        <h6 class="mb-0 fw-semibold text-primary">CurrentTrips</h6>
                    ...
                    {{-- RIGHT SIDE BUTTON --}}
                    <a href="{{ route('watson.trips.history') }}" class="btn btn-outline-secondary btn-sm ui-pill-btn">
                ...
                <div
                    ...
                    <form method="GET" action="{{ route('watson.trips.index') }}"
                        ...
                        @if (request('q'))
                            <a href="{{ route('watson.trips.index', request()->except('q', 'page')) }}"
                    ...
                    <div class="ui-table-scroll">
                        <table class="table ui-table align-middle mb-0">
                            ...
                            <tbody>
                                @forelse ($trips as $t)
                                    <tr>
                                        <td class="text-center d-flex  gap-1 align-items-center justify-content-center">
                                            @if ($t->status == 'Draft')
                                                {{-- DISPATCH --}}
                                                <form method="POST" action="{{ route('watson.trips.assign', $t->id) }}"
                                                    class="trip-dispatch">
                                                    @csrf
                                            ...
                                            @if ($t->status == 'Dispatched')
                                                <div class="d-flex gap-2">
                                                    {{-- DELIVERED --}}
                                                    <form method="POST"
                                                        action="{{ route('watson.trips.deliver', $t->id) }}"
                                        ...
                                        <td>
                                            ...
                                            @if (in_array($t->status, ['Draft', 'Dispatched', 'Assigned', 'Completed']))
                                                @php
                                        ...
                                        <td>
                                            {{ $t->dispatch_date ? \Carbon\Carbon::parse($t->dispatch_date)->format('F d,Y') : '-' }}
                                        </td>
                                        <td>
                                            {{ $t->destination?->destination_name ?? '-' }}
                                        </td>
                                        <td>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-footer">
                    ...
                    <form method="POST" action="{{ route('watson.trips.destroyAll') }}">
                        @csrf
                        @method('DELETE')
