            ...
            <div class="card-header bg-transparent border-0 pb-0">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                    ...
                    <div class="d-flex align-items-center gap-2 flex-wrap ms-auto">
                        ...
                        {{-- ✅ TRIP HISTORY BUTTON --}}
                        <a href="{{ route('watson.trips.history') }}" class="btn btn-outline-dark ui-btn-equal">
                        ...
                        <form class="billing-filter">
                            ...
                            <div class="d-flex align-items-center gap-2 flex-wrap flex-md-nowrap">
                                ...
                                <a href="{{ route('watson.payroll.billing') }}" class="btn btn-light filter-btn-clear">
                                    Clear
                                </a>
            ...
            <div class="modal fade" id="billTripModal-{{ $t->id }}" tabindex="-1">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content border-0 shadow">
                        ...
                        <form method="POST" action="{{ route('watson.trips.complete', $t->id) }}">
                            @csrf
