            ...
            <div class="modal-dialog modal-md modal-dialog-centered">
                <div class="modal-content border-0 shadow">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ route('watson.trucks.store') }}">
                            @csrf
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="d-inline-flex gap-2">
                                                            ...
                                                            <form
                                                                action="{{ route('watson.trucks.destroy', $truck->id) }}"
                        ...
                        <div class="card border-0 shadow-sm mb-3 ui-mobile-truck">
                            <div class="card-body">
                                ...
                                <div class="mt-3 d-flex justify-content-end gap-2 ui-mobile-actions">
                                    ...
                                    <form action="{{ route('watson.trucks.destroy', $truck->id) }}" method="POST"
        ...
        <div class="modal fade" id="editTruckModal-6w-{{ $truck->id }}" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-md modal-dialog-centered">
                <div class="modal-content border-0 shadow">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ route('watson.trucks.update', $truck->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Plate
                                    Number</label>
                                <input class="form-control border border-primary text-primary" name="plate_number"
                                    value="{{ $truck->plate_number }}" required>
                            </div>
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Truck
                                    Type</label>
                                @php
                                    $truckType = ['4W', '6W', 'AUV', '4WCV', 'L300'];
                                @endphp
                                <select class="form-select" name="truck_type" required>
                                    @foreach ($truckType as $type)
                                        <option value="{{ $type }}"
                                            {{ $truck->truck_type === $type ? 'selected' : '' }}>
                                            {{ $type }}</option>
                                    @endforeach
                                </select>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-footer">
                    ...
                    <form method="POST" action="{{ route('watson.trucks.destroyAll') }}">
                        @csrf
                        @method('DELETE')
