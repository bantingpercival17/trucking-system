                            ...
                            <tbody>
                                @forelse($employees as $driver)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-primary">{{ strtoupper($driver->type) }}</span>
                                        </td>
                                        <td>{{ $driver->email }}</td>
                                        <td>
                                            <span class="badge bg-{{ $driver->is_active ? 'info' : 'danger' }}">
                                                {{ ucfirst($driver->is_active ? 'Active' : 'inActive') }}
                                            </span>
                                        </td>

                                        <td>
                                            <span class="badge bg-info">
                                                {{ ucfirst($driver->is_available ? 'Available' : 'unAvailable') }}
                                            </span>
                                        </td>
            ...
            <div class="modal fade" id="editDriverModal-{{ $driver->id }}" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-xl modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form method="POST" action="{{ route('watson.drivers.update', $driver->id) }}"
                            enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
