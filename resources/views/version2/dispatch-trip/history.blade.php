            ...
            <div class="card-header bg-transparent border-0 pb-0">
                ...
                <div
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <a href="{{ route('admin.dispatch.index') }}" class="btn btn-outline-secondary btn-sm ui-pill-btn">
                            <i class="bi bi-truck me-1"></i> Dispatch
                        </a>
                        <a href="{{ route('watson.payroll.billing') }}"
                            class="btn btn-outline-secondary btn-sm ui-pill-btn">
                                ...
                                <div class="col-md  dispatch-action">
                                    ...
                                    <div class="action-button mt-2 row">
                                        @if (in_array(auth()->user()->role, ['owner', 'it']))
                                            <div class="col-md">
                                                <form action="{{ route('watson.trips.destroy', $item->id) }}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="person-stack">
                                            ...
                                            @endif
                                            @if ($t->helper && $t->helper->helper)
                                                <div class="person-avatar color-2"
                                                    data-name="{{ $t->helper->helper->name }} (Helper)">
                                                    {{ strtoupper(substr($t->helper->helper->name, 0, 1)) }}
                                                </div>
                                            @endif
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn p-0 billing-toggle"
                                            data-url="{{ route('watson.trips.updateBilling', $t->id) }}">
            ...
            : ($paymentStatus == 'Partial'
                ...
                : 'bg-secondary') }}">
                                    ...
                                    <td class="text-center d-flex justify-content-center gap-1">
                                        ...
                                        @if (in_array(auth()->user()->role, ['owner', 'it']))
                                            <form action="{{ route('watson.trips.destroy', $t->id) }}" method="POST"
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-primary"
                                            data-bs-toggle="modal" data-bs-target="#editBillingModal{{ $t->id }}">
                                            <i class="bi bi-pencil"></i>
                                        </button>
