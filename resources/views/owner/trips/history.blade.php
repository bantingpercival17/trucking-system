            ...
            <div class="card-header bg-transparent border-0 pb-0">
                ...
                <div
                    ...
                    <form method="GET" action="{{ route('owner.trips.history') }}"
                        ...
                        <select name="billing_status" class="form-select form-select-sm" onchange="this.form.submit()">

                            <option value="">All Billing</option>
                            <option value="Unbilled" {{ request('billing_status') == 'Unbilled' ? 'selected' : '' }}>
                                Unbilled
                            </option>
                            <option value="Pending" {{ request('billing_status') == 'Pending' ? 'selected' : '' }}>
                                Pending
                            </option>
                            <option value="Billed" {{ request('billing_status') == 'Billed' ? 'selected' : '' }}>
                                Billed
                            </option>
                        </select>
