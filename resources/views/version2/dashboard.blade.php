...
@section('content')
    <div class="row">
        <div class="col-lg-4">
            <div class="card text-center text-primary ">
                <div class="card-body">
                    <h5 class="mb-3 text-primary fw-bolder">FINANCIAL SUMMARY</h5>
                    <div class="row g-3">
                        <div class="col-6">
                            <p class="mb-1 small text-muted fw-bold">Total Gains</p>
                            <h5 class="fw-bolder text-primary mb-0" data-bs-toggle="tooltip" data-bs-html="true"
    ...
    ">
                        ...
                        <div class="col-6">
                            <p class="mb-1 small text-muted fw-bold">Expenses</p>
                            <h5 class="fw-bolder text-info mb-0" data-bs-toggle="tooltip" data-bs-html="true"
                                title="
    ...
    ">
                        ...
                        <div class="col-12">
                            ...
                            <p class="mb-1 small text-muted fw-bold">Net Profit</p>
        ...
        <div class="col-lg-8 col-md-12">
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <a href="{{ route('watson.trucks.index') }}">
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <h5 class="text-primary mb-0">Employee</h5>
                                <a href="{{ route('watson.drivers.index') }}">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <h3 class="mb-0">{{ $employeeStatus['total'] ?? 0 }}</h3>
                                <p class="mb-0 ms-2 text-muted">{{ $employeeStatus['active'] ?? 0 }} active</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <a href="{{ route('watson.destinations.index') }}">
                                    <svg width="17" height="13" viewBox="0 0 17 13" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1 6.49905L6.0014 11.4984L16 1.49976" stroke="#7B60E7" stroke-width="1.5"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <a href="{{ route('watson.trips.index') }}">
                                    <svg width="15" height="13" viewBox="0 0 15 17" fill="currentcolor"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7.72461 0.75L7.72461 15.75" stroke="currentcolor" stroke-width="1.5"
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class=text-primary fw-bolder">WEEKLY FINANCIAL SUMMARY</h4>
                </div>
                <div class="card-body">
                    <div class="card-group border rounded-1">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    ...
                                    <span class="badge bg-soft-success text-dark">
                                        {{ $profits['todayData']['dispatched'] ?? 0 }}
                                    </span>
                                </div>
                                <h5
                                    class="mb-1 
                                            {{ $profits['todayData']['profit'] >= 0 ? 'text-success' : 'text-danger' }}">
                                    ₱{{ number_format($profits['todayData']['profit'] ?? 0, 2) }}
                                </h5>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="mb-1">₱{{ number_format($profits['todayData']['profit'] ?? 0, 2) }}
                                </h5>
            ...
            <div class="d-flex flex-column gap-3">
                ...
                <div class="card" data-iq-gsap="onStart" data-iq-position-y="70" data-iq-rotate="0"
                    ...
                    <div class="card-header justify-content-between d-flex align-items-center">
                        ...
                        <a href="{{ route('watson.trips.index') }}" class="btn btn-primary btn-sm">View All</a>
                    </div>
                                    ...
                                    <div class="card border h-100">
                                        <div class="card-body">
                                            ...
                                            <p class="mb-1 small">
                                                ...
                                                {{ $trip->destination?->destination_name ?? 'N/A' }}
                                            </p>
                ...
                <div class="card" data-iq-gsap="onStart" data-iq-position-y="70" data-iq-rotate="0"
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('watson.destinations.index') }}" class="btn btn-primary btn-sm">View all</a>
                    </div>
                                ...
                                <div class="col">
                                    <div class="card border h-100">
                                        <div class="card-body">
                                            ...
                                            <h6 class="card-title mb-2">{{ $destination->destination_name ?? 'N/A' }}</h6>
                                            <p class="mb-1 small"><strong>Origin:</strong>
                                                {{ $destination->origin ?? '—' }}</p>
            ...
            <div class="d-flex flex-column gap-3">
                ...
                <div class="card" data-iq-gsap="onStart" data-iq-position-y="70" data-iq-rotate="0"
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('watson.trips.history') }}" class="btn btn-primary btn-sm"> View All </a>
                    </div>
                        ...
                        @forelse($recentTrips as $trip)
                            <div
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <span
                                        class="text-muted small">{{ $trip->destination?->destination_name ?? 'No destination' }}</span>
                                </div>
